<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Dinero.aspx.vb" Inherits="Dinero" %>
...
<body>
    <form id="form1" runat="server">
        <p>
            <asp:TextBox ID="tbEurDol1" runat="server" TextMode="Number" min="1" value="1" AutoPostBack="true"></asp:TextBox>
        ...
        <p>
            <asp:TextBox ID="tbEurDol2" runat="server" TextMode="Number" min="1" value="1" AutoPostBack="true"></asp:TextBox>
